...
let custom_tests =
  [
    ( "Day 03 - CUSTOM"
    , [
        Alcotest.test_case "Test Input - Part 1 -  Line 1" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            98
            (Aoc2025.Day03.extract_largest_number "987654321111111")
        )
      ; Alcotest.test_case "Test Input - Part 1 -  Line 2" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            89
            (Aoc2025.Day03.extract_largest_number "811111111111119")
        )
      ; Alcotest.test_case "Test Input - Part 1 -  Line 3" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            78
            (Aoc2025.Day03.extract_largest_number "234234234234278")
        )
      ; Alcotest.test_case "Test Input - Part 1 -  Line 4" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            92
            (Aoc2025.Day03.extract_largest_number "818181911112111")
        )
      ; Alcotest.test_case "Test Input - Part 2 -  Line 1" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            987654321111
            (Aoc2025.Day03.extract_largest_number ~num_digits:12 "987654321111111")
        )
      ; Alcotest.test_case "Test Input - Part 2 -  Line 2" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            811111111119
            (Aoc2025.Day03.extract_largest_number ~num_digits:12 "811111111111119")
        )
      ; Alcotest.test_case "Test Input - Part 2 -  Line 3" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            434234234278
            (Aoc2025.Day03.extract_largest_number ~num_digits:12 "234234234234278")
        )
      ; Alcotest.test_case "Test Input - Part 2 -  Line 4" `Quick (fun () ->
          Alcotest.(check int)
            "must be equal"
            888911112111
